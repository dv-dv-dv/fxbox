...
def filter_audio(np.ndarray[FTYPE_t, ndim=2] audio_in, np.ndarray[FTYPE_t] a_flipped, np.ndarray[FTYPE_t] b_flipped, int nm_max, np.ndarray[FTYPE_t, ndim=2] x, np.ndarray[FTYPE_t, ndim=2] y):
    ...
    cdef np.ndarray[FTYPE_t, ndim=2] audio_out = y[nm_max:y.shape[0]]
