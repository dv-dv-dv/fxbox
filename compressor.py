...
class Compressor:
    ...
    def update_params(self, threshold=None, ratio=None, knee_width=None, pre_gain=None, post_gain=None, attack=None, release=None, rms=None):
